!function() {
    if ("ontouchstart"in window) {
        ...
        i = function(e) {
            ...
            s.x = r,
            s.y = i,
            !((!e.simulated && (n < 500 || n < 1500 && a[0] < 50 && a[1] < 50) || f) && (e.preventDefault(),
            e.stopPropagation(),
            !f)) && (f && (window.location = u.getAttribute("href")),
            void (u && u.classList && (u.classList.add("energize-focus"),
...
function(e, t) {
    ...
    function o(e, t, n) {
        ...
        }) : Ce.test(t) ? ge.filter(t, e, n) : (t = ge.filter(t, e),
    ...
    function g(e, t, n, r) {
        ...
        , u = a(), c = n && n[3] || (ge.cssNumber[t] ? "" : "px"), l = (ge.cssNumber[t] || "px" !== c && +u) && Me.exec(ge.css(e, t));
        if (l && l[3] !== c) {
            c = c || l[3],
            n = n || [],
            l = +u || 1;
    ...
    function m(e, t) {
        for (var n, r, i = [], o = 0, s = e.length; o < s; o++)
            ...
            i[o] || (r.style.display = "")),
            "" === r.style.display && Be(r) && (i[o] = v(r))) : "none" !== n && (i[o] = "none",
            Pe.set(r, "display", n)));
        for (o = 0; o < s; o++)
    ...
    function L(e, t, r, i) {
        ...
        s || i)) {
            for (a = ge.map(y(o, "script"), k),
            u = a.length; f < d; f++)
                c = o,
                f !== p && (c = ge.clone(c, !0, !0),
                u && ge.merge(a, y(c, "script"))),
                r.call(e[f], c, f);
            if (u)
                ...
                f = 0; f < u; f++)
                    c = a[f],
                    Qe.test(c.type || "") && !Pe.access(c, "globalEval") && ge.contains(l, c) && (c.src ? ge._evalUrl && ge._evalUrl(c.src) : n(c.textContent.replace(ot, ""), l))
        }
        return e
    }
    function D(e, t, n) {
        for (var r, i = t ? ge.filter(t, e) : e, o = 0; null != (r = i[o]); o++)
            ...
            r.parentNode && (n && ge.contains(r.ownerDocument, r) && x(y(r, "script")),
    ...
    function H(e, t, n, r, i) {
        ...
        for (o = n === (r ? "border" : "content") ? 4 : "width" === t ? 1 : 0; o < 4; o += 2)
            ...
            r ? ("content" === n && (s -= ge.css(e, "padding" + We[o], !0, i)),
            "margin" !== n && (s -= ge.css(e, "border" + We[o] + "Width", !0, i))) : (s += ge.css(e, "padding" + We[o], !0, i),
            "padding" !== n && (s += ge.css(e, "border" + We[o] + "Width", !0, i)));
        return s
    }
    function I(e, t, n) {
    ...
    function _() {
        vt && (ne.hidden === !1 && e.requestAnimationFrame ? e.requestAnimationFrame(_) : e.setTimeout(_, ge.fx.interval),
        ge.fx.tick())
    }
    function M() {
    ...
    function z(e, t, n) {
        ...
        if (u = !ge.isEmptyObject(t),
        u || !ge.isEmptyObject(p)) {
            ...
            l = ge.css(e, "display"),
            m([e]))),
            ("inline" === l || "inline-block" === l && null != c) && "none" === ge.css(e, "float") && (u || (d.done(function() {
                h.display = c
            }),
            null == c && (l = h.display,
            c = "none" === l ? "" : l)),
            ...
            u = !1;
            for (r in p)
                u || (v ? "hidden"in v && (g = v.hidden) : v = Pe.access(e, "fxshow", {
                    display: c
                }),
                o && (v.hidden = !g),
                g && m([e], !0),
    ...
    function X(e, t, n) {
        var r, i, o = 0, s = X.prefilters.length, a = ge.Deferred().always(function() {
            ...
            if (i)
                return !1;
            for (var t = gt || M(), n = Math.max(0, c.startTime + c.duration - t), r = n / c.duration || 0, o = 1 - r, s = 0, u = c.tweens.length; s < u; s++)
                c.tweens[s].run(o);
            return a.notifyWith(e, [c, o, n]),
            o < 1 && u ? n : (u || a.notifyWith(e, [c, 1, 0]),
            a.resolveWith(e, [c]),
            !1)
        }, c = a.promise({
            elem: e,
        ...
        a--); a < u; a++)
            if (null != (e = arguments[a]))
                for (t in e)
                    n = s[t],
                    r = e[t],
                    s !== r && (c && r && (ge.isPlainObject(r) || (i = Array.isArray(r))) ? (i ? (i = !1,
    ...
    ge.extend({
        ...
        isPlainObject: function(e) {
            var t, n;
            return !(!e || "[object Object]" !== ce.call(e)) && (!(t = re(e)) || (n = le.call(t, "constructor") && t.constructor,
 ...
 */
    function(e) {
        function t(e, t, n, r) {
            ...
            "string" != typeof e || !e || 1 !== h && 9 !== h && 11 !== h)
                return n;
            if (!r && ((t ? t.ownerDocument || t : M) !== q && O(t),
            t = t || q,
            $)) {
                if (11 !== h && (u = me.exec(e)))
                    if (i = u[1]) {
                ...
                if (T.qsa && !X[e + " "] && (!P || !P.test(e))) {
                    if (1 !== h)
                        ...
                        for ((a = t.getAttribute("id")) ? a = a.replace(we, Te) : t.setAttribute("id", a = _),
                        c = k(e),
                        o = c.length; o--; )
                            c[o] = "#" + a + " " + p(c[o]);
                        l = c.join(","),
        ...
        var w, T, S, E, C, k, N, j, A, L, D, O, q, F, $, P, H, I, R, _ = "sizzle" + 1 * new Date, M = e.document, W = 0, B = 0, z = n(), V = n(), X = n(), U = function(e, t) {
            return e === t && (D = !0),
            0
        }, Q = {}.hasOwnProperty, Y = [], J = Y.pop, G = Y.push, K = Y.push, Z = Y.slice, ee = function(e, t) {
            for (var n = 0, r = e.length; n < r; n++)
                if (e[n] === t)
                    return n;
            return -1
        }, te = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", ne = "[\\x20\\t\\r\\n\\f]", re = "(?:\\\\.|[\\w-]|[^\0-\\xa0])+", ie = "\\[" + ne + "*(" + re + ")(?:" + ne + "*([*^$|!~]?=)" + ne + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + re + "))|)" + ne + "*\\]", oe = ":(" + re + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + ie + ")*)|.*)\\)|)", se = new RegExp(ne + "+","g"), ae = new RegExp("^" + ne + "+|((?:^|[^\\\\])(?:\\\\.)*)" + ne + "+$","g"), ue = new RegExp("^" + ne + "*," + ne + "*"), ce = new RegExp("^" + ne + "*([>+~]|" + ne + ")" + ne + "*"), le = new RegExp("=" + ne + "*([^\\]'\"]*?)" + ne + "*\\]","g"), fe = new RegExp(oe), de = new RegExp("^" + re + "$"), pe = {
            ID: new RegExp("^#(" + re + ")"),
            CLASS: new RegExp("^\\.(" + re + ")"),
            TAG: new RegExp("^(" + re + "|[*])"),
            ATTR: new RegExp("^" + ie),
        ...
        O = t.setDocument = function(e) {
            ...
            F = q.documentElement,
            $ = !C(q),
            M !== q && (n = q.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", Se, !1) : n.attachEvent && n.attachEvent("onunload", Se)),
            ...
            H = [],
            P = [],
            (T.qsa = ve.test(q.querySelectorAll)) && (i(function(e) {
            ...
            U = t ? function(e, t) {
                ...
                1 & n || !T.sortDetached && t.compareDocumentPosition(e) === n ? e === q || e.ownerDocument === M && R(M, e) ? -1 : t === q || t.ownerDocument === M && R(M, t) ? 1 : L ? ee(L, e) - ee(L, t) : 0 : 4 & n ? -1 : 1)
            }
            : function(e, t) {
                if (e === t)
                    return D = !0,
                ...
                if (!i || !o)
                    return e === q ? -1 : t === q ? 1 : i ? -1 : o ? 1 : L ? ee(L, e) - ee(L, t) : 0;
                if (i === o)
                    return s(e, t);
        ...
        t.matchesSelector = function(e, n) {
            if ((e.ownerDocument || e) !== q && O(e),
            n = n.replace(le, "='$1']"),
            T.matchesSelector && $ && !X[n + " "] && (!H || !H.test(n)) && (!P || !P.test(n)))
                try {
                    var r = I.call(e, n);
        ...
        t.contains = function(e, t) {
            return (e.ownerDocument || e) !== q && O(e),
            R(e, t)
        }
        ,
        t.attr = function(e, t) {
        ...
        S = t.selectors = {
            ...
            filter: {
                ...
                CHILD: function(e, t, n, r, i) {
                    ...
                    : function(t, n, u) {
                        ...
                        if (v) {
                            ...
                            x = p),
                            x === !1)
                                for (; (d = ++p && d && d[g] || (x = p = 0) || h.pop()) && ((a ? d.nodeName.toLowerCase() !== m : 1 !== d.nodeType) || !++x || (y && (f = d[_] || (d[_] = {}),
                                l = f[d.uniqueID] || (f[d.uniqueID] = {}),
                                l[e] = [W, x]),
                                d !== t)); )
                                    ;
                ...
                PSEUDO: function(e, n) {
                    ...
                    return o[_] ? o(n) : o.length > 1 ? (i = [e, e, "", n],
        ...
        j = t.select = function(e, t, n, r) {
            ...
            1 === l.length) {
                ...
                o.length > 2 && "ID" === (s = o[0]).type && 9 === t.nodeType && $ && S.relative[o[1].type]) {
                    if (t = (S.find.ID(s.matches[0].replace(xe, be), t) || [])[0],
                    !t)
                        return n;
                    c && (t = t.parentNode),
            ...
            return (c || N(e, l))(r, t, !$, n, !t || ye.test(e) && f(t.parentNode) || t),
            n
        }
        ,
    ...
    var ke, Ne = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/, je = ge.fn.init = function(e, t, n) {
        ...
        if (n = n || ke,
        "string" == typeof e) {
            if (r = "<" === e[0] && ">" === e[e.length - 1] && e.length >= 3 ? [null, e, null] : Ne.exec(e),
            !r || !r[1] && t)
    ...
    ge.each({
        ...
        ge.fn[e] = function(n, r) {
            ...
            this.length > 1 && (Le[e] || ge.uniqueSort(i),
            Ae.test(e) && i.reverse()),
            this.pushStack(i)
        }
    });
    ...
    ge.extend({
                            ...
                            var a = this
                              ...
                              , f = function() {
                                ...
                                if (!(t < s)) {
                                    ...
                                    ge.isFunction(f) ? i ? f.call(e, o(s, n, u, i), o(s, n, c, i)) : (s++,
                                    f.call(e, o(s, n, u, i), o(s, n, c, i), o(s, n, u, n.notifyWith))) : (r !== u && (a = void 0,
                                    l = [e]),
                                    (i || n.resolveWith)(a, l))
                                }
                            }
        ...
        when: function(e) {
            ...
            if (t <= 1 && (l(e, o.done(s(n)).resolve, o.reject, !t),
    ...
    ge.event = {
            ...
            if (v && (u = v.events)) {
                ...
                c = t.length; c--; )
                    ...
                    p) {
                        ...
                        s && !d.length && (f.teardown && f.teardown.call(e, h, v.handle) !== !1 || ge.removeEvent(e, p, v.handle),
                        delete u[p])
                    } else
                        for (p in u)
                            ge.event.remove(e, p + t[c], n, r, !0);
        ...
        dispatch: function(e) {
            ...
            !l.preDispatch || l.preDispatch.call(this, a) !== !1) {
                for (s = ge.event.handlers.call(this, a, c),
                t = 0; (i = s[t++]) && !a.isPropagationStopped(); )
                    ...
                    n = 0; (o = i.handlers[n++]) && !a.isImmediatePropagationStopped(); )
                        ...
                        a.data = o.data,
                        r = ((ge.event.special[o.origType] || {}).handle || o.handler).apply(i.elem, u),
    ...
    ge.Event = function(e, t) {
        ...
        this.type = e.type,
        this.isDefaultPrevented = e.defaultPrevented || void 0 === e.defaultPrevented && e.returnValue === !1 ? w : T,
    ...
    ge.extend({
        ...
        style: function(e, t, n, r) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                ...
                "string" === o && (i = Me.exec(n)) && i[1] && (n = g(e, t, i),
                o = "number"),
                null != n && n === n && ("number" === o && (n += i && i[3] || (ge.cssNumber[a] ? "" : "px")),
    ...
    ge.each(["height", "width"], function(e, t) {
        ge.cssHooks[t] = {
            get: function(e, n, r) {
                if (n)
                    return !ct.test(ge.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? I(e, t, r) : ze(e, ft, function() {
                        return I(e, t, r)
                    })
            },
            set: function(e, n, r) {
                var i, o = r && ut(e), s = r && H(e, t, r, "border-box" === ge.css(e, "boxSizing", !1, o), o);
                return s && (i = Me.exec(n)) && "px" !== (i[3] || "px") && (e.style[t] = n,
                n = ge.css(e, t)),
                P(e, n, s)
            }
        }
    ...
    ge.extend({
        attr: function(e, t, n) {
            ...
            if (3 !== o && 8 !== o && 2 !== o)
                return "undefined" == typeof e.getAttribute ? ge.prop(e, t, n) : (1 === o && ge.isXMLDoc(e) || (i = ge.attrHooks[t.toLowerCase()] || (ge.expr.match.bool.test(t) ? xt : void 0)),
        ...
        toggleClass: function(e, t) {
            ...
            return "boolean" == typeof t && "string" === n ? t ? this.addClass(e) : this.removeClass(e) : ge.isFunction(e) ? this.each(function(n) {
                ...
                if ("string" === n)
                    ...
                    this.setAttribute && this.setAttribute("class", t || e === !1 ? "" : Pe.get(this, "__className__") || ""))
            })
        },
        hasClass: function(e) {
            var t, n, r = 0;
    ...
    ge.fn.extend({
        val: function(e) {
            var t, n, r, i = this[0];
            {
                ...
                if (i)
                    return t = ge.valHooks[i.type] || ge.valHooks[i.nodeName.toLowerCase()],
    ...
    ge.extend(ge.event, {
        trigger: function(t, n, r, i) {
            ...
            if (s = a = r = r || ne,
            3 !== r.nodeType && 8 !== r.nodeType && !Et.test(p + ge.event.triggered) && (p.indexOf(".") > -1 && (h = p.split("."),
            p = h.shift(),
            h.sort()),
            c = p.indexOf(":") < 0 && "on" + p,
            ...
            i || !f.trigger || f.trigger.apply(r, n) !== !1)) {
                if (!i && !f.noBubble && !ge.isWindow(r)) {
                    ...
                    Et.test(u + p) || (s = s.parentNode); s; s = s.parentNode)
                        d.push(s),
                        a = s;
                ...
                for (o = 0; (s = d[o++]) && !t.isPropagationStopped(); )
                    ...
                    l && l.apply(s, n),
                    l = c && s[c],
                    l && l.apply && $e(s) && (t.result = l.apply(s, n),
                    t.result === !1 && t.preventDefault());
                return t.type = p,
                i || t.isDefaultPrevented() || f._default && f._default.apply(d.pop(), n) !== !1 || !$e(r) || c && ge.isFunction(r[p]) && !ge.isWindow(r) && (a = r[c],
                a && (r[c] = null),
    ...
    ge.extend({
        ...
        ajax: function(t, n) {
            function r(t, n, r, a) {
                ...
                r && (b = Z(h, S, r)),
                b = ee(h, b, S, c),
                c ? (h.ifModified && (w = S.getResponseHeader("Last-Modified"),
                ...
                S.statusCode(x),
                x = void 0,
                f && v.trigger(c ? "ajaxSuccess" : "ajaxError", [S, h, c ? d : p]),
                y.fireWith(g, [S, T]),
            ...
            if (m.promise(S),
            h.url = ((t || h.url || Ct.href) + "").replace(It, Ct.protocol + "//"),
            ...
            p = (Nt.test(o) ? "&" : "?") + "_=" + kt++ + p),
            h.url = o + p),
            h.ifModified && (ge.lastModified[o] && S.setRequestHeader("If-Modified-Since", ge.lastModified[o]),
...
function() {
    ...
    function s(t) {
        ...
        var i = r();
        i ? (e(i),
        localStorage.setItem("language", i)) : e(null !== n && jQuery.inArray(n, a) != -1 ? n : a[0])
    }
    var a = [];
...
function() {
   ...
   */
    ...
    e.Pipeline.prototype.run = function(e) {
        for (var t = [], n = e.length, r = this._stack.length, i = 0; i < n; i++) {
            for (var o = e[i], s = 0; s < r && (o = this._stack[s](o, i, e),
            void 0 !== o); s++)
                ;
            void 0 !== o && t.push(o)
        }
   ...
   */
    ...
    e.Vector.prototype.insert = function(t, n) {
        ...
        for (var i = r, o = r.next; void 0 != o; ) {
            if (t < o.idx)
                return i.next = new e.Vector.Node(t,n,o),
                this.length++;
            i = o,
            o = o.next
        }
   ...
   */
    ...
    e.SortedSet.prototype.intersect = function(t) {
        for (var n = new e.SortedSet, r = 0, i = 0, o = this.length, s = t.length, a = this.elements, u = t.elements; ; ) {
            if (r > o - 1 || i > s - 1)
                break;
            a[r] !== u[i] ? a[r] < u[i] ? r++ : a[r] > u[i] && i++ : (n.add(a[r]),
            r++,
            i++)
        }
        return n
   ...
   */
    ...
    e.Index.prototype.add = function(t, n) {
        ...
        this._fields.forEach(function(n) {
            ...
            r[n.name] = o,
            e.SortedSet.prototype.add.apply(i, o)
        }, this),
        ...
        var e = {
          ...
          , L = function(n) {
            ...
            s.test(n)) {
                ...
                u = b,
                c = w,
                a.test(n) ? n += "e" : u.test(n) ? (s = y,
                n = n.replace(s, "")) : c.test(n) && (n += "e"))
            }
            if (s = T,
            s.test(n)) {
                var L = s.exec(n);
   ...
   */
    ...
    e.TokenStore.prototype.add = function(e, t, n) {
        ...
        0 === i.length ? (n[r].docs[t.ref] = t,
        void (this.length += 1)) : this.add(i, t, n[r])
    }
    ,
...
function() {
    ...
    function r(e) {
        ...
        t.value) {
            ...
            i.call(t)) : (a.html("<li></li>"),
            $(".search-results li").text('No Results Found for "' + t.value + '"'))
        } else
            o(),
